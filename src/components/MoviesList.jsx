        ...
        return (
          ...
          >
            <article>
              ...
              <div className="photo-info  absolute bottom-0 flex h-32 w-full translate-y-full transform flex-col justify-center space-y-1 bg-black/50 px-8 text-gray-200 backdrop-blur-sm transition-all duration-300 ease-linear">
